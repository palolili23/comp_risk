...
This repository contains code to estimate the different estimates
...
following:
  ...
  - `risk_diff_ratio`: Uses the output from `n_wrapper` to calculate the
    following estimates (with 95% Confidence intervals):
